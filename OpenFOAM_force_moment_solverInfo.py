...
df_force = pd.read_csv("/home/mario/pythonProjects/OpenFOAM_auswerten/force.dat", sep=r'\s+', skiprows=3)
df_moment = pd.read_csv("/home/mario/pythonProjects/OpenFOAM_auswerten/moment.dat", sep=r'\s+', skiprows=3)
...
####################################################################
# read text file into pandas DataFrame
df_solver = pd.read_csv("/home/mario/pythonProjects/OpenFOAM_auswerten/solverInfo.dat", sep=r'\s+', skiprows=1)
# in python 3.12 '\s+' gives invalid escape sequence warning, thus r'\s+' necessary
